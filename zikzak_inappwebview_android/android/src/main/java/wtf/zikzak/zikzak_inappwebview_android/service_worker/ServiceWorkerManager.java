package wtf.zikzak.zikzak_inappwebview_android.service_worker;
...
public class ServiceWorkerManager implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME = "wtf.zikzak/zikzak_inappwebview_serviceworkercontroller";
  ...
  public void setServiceWorkerClient(Boolean isNull) {
    if (serviceWorkerController != null) {
      ...
      // https://github.com/arrrrny/zikzak_inappwebview/issues/1151
