#ifndef zikzak_inappWEBVIEW_PLUGIN_BASE_CALLBACK_RESULT_H_
#define zikzak_inappWEBVIEW_PLUGIN_BASE_CALLBACK_RESULT_H_
...
#endif //zikzak_inappWEBVIEW_PLUGIN_BASE_CALLBACK_RESULT_H_
