#ifndef zikzak_inappWEBVIEW_PLUGIN_IN_APP_WEBVIEW_SETTINGS_H_
#define zikzak_inappWEBVIEW_PLUGIN_IN_APP_WEBVIEW_SETTINGS_H_
...
#endif //zikzak_inappWEBVIEW_PLUGIN_IN_APP_WEBVIEW_SETTINGS_H_
