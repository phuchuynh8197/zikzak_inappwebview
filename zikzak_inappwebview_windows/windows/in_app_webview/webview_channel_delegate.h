#ifndef zikzak_inappWEBVIEW_PLUGIN_WEBVIEW_CHANNEL_DELEGATE_H_
#define zikzak_inappWEBVIEW_PLUGIN_WEBVIEW_CHANNEL_DELEGATE_H_
...
#endif //zikzak_inappWEBVIEW_PLUGIN_WEBVIEW_CHANNEL_DELEGATE_H_
