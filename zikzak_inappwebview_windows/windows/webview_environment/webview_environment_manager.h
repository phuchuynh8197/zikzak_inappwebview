#ifndef zikzak_inappWEBVIEW_PLUGIN_WEBVIEW_ENVIRONMENT_MANAGER_H_
#define zikzak_inappWEBVIEW_PLUGIN_WEBVIEW_ENVIRONMENT_MANAGER_H_
...
namespace zikzak_inappwebview_plugin
{
  ...
  public:
    ...
    static inline const std::string METHOD_CHANNEL_NAME = "wtf.zikzak/flutter_webview_environment";
...
#endif //zikzak_inappWEBVIEW_PLUGIN_WEBVIEW_ENVIRONMENT_MANAGER_H_
